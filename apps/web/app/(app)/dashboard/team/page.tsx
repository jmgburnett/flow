...
export default function TeamDashboardPage() {
	...
	const sections = [
		...
		},
		{
			...
			stat: okrDashboard ? `${okrDashboard.overallProgress}% progress` : undefined,
		},
		{
			title: "Org Chart",
			...
			<div className="space-y-5 p-4 md:p-6 max-w-2xl mx-auto w-full">
				...
				<div className="pt-1">
					<div className="flex items-center gap-2 mb-1">
						...
						<h1 className="text-2xl font-display font-semibold tracking-tight">TeamOS</h1>
					</div>
				...
				{okrDashboard && okrDashboard.activeCount > 0 && (
					<div className="glass-card rounded-2xl p-4">
						<div className="flex items-center gap-2 mb-3">
							...
							<span className="text-sm font-semibold tracking-tight">OKR Health</span>
						...
						<div className="flex gap-3">
							{[
								{ label: "On Track", count: okrDashboard.ragBreakdown.green, color: "bg-emerald-500" },
								{ label: "At Risk", count: okrDashboard.ragBreakdown.amber, color: "bg-amber-500" },
								{ label: "Behind", count: okrDashboard.ragBreakdown.red, color: "bg-red-500" },
								{ label: "Not Started", count: okrDashboard.ragBreakdown.not_started, color: "bg-gray-400" },
							...
							<Link key={section.title} href={section.href}>
								<div className="glass-card rounded-2xl p-4 hover:shadow-md active:scale-[0.99] transition-all">
									<div className="flex items-center gap-3">
										<div className={cn("flex h-10 w-10 items-center justify-center rounded-xl shrink-0", section.color)}>
										...
										<div className="flex-1 min-w-0">
											<div className="flex items-center gap-2">
												...
												{section.stat && (
													<span className="text-[10px] text-muted-foreground ml-auto">{section.stat}</span>
												)}
											</div>
							...
							<div className="flex items-center gap-3">
								...
								<div className="flex-1">
									<p className="text-sm font-medium">
										{pendingActions} action item{pendingActions !== 1 ? "s" : ""} need review
									</p>
									<p className="text-xs text-muted-foreground">From meeting transcripts</p>
								</div>
